...
deepspeed --include localhost:0,1,2,3 --master_port 29501 tinyllava/train/train.py \
    ...
    --tune_vision_tower_from_layer 12 \
    --tune_type_connector full \
    --pretrained_model_path output/Final/tiny-llava-${LLM_VARIANT}-${VT_VARIANT}-${VERSION}-pretrain \
    --output_dir output/Final/tiny-llava-${LLM_VARIANT}-${VT_VARIANT}-${VERSION}-pretrain-share \
    --num_train_epochs 1 \
    ...
    --run_name tiny-llava-${LLM_VARIANT}-${VT_VARIANT}-${VERSION}-pretrain-share
